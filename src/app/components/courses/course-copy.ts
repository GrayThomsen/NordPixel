export function getCoursesCopy(locale: 'da' | 'en') {
  return {
    da: {
      ...
      pricingDeliveryModelText: 'Primært video-instruktion og tilsendt materiale. Ikke baseret på løbende timeregistrering.',
      ...
      customTrackOfferLine: 'Custom forløb: Pris aftales ved planlægning.',
    ...
    en: {
      ...
      pricingDeliveryModelText: 'Primarily video instruction and delivered materials. Not based on ongoing time tracking.',
