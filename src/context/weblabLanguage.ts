...
export const weblabLanguage: Record<Locale, {
  ...
  da: {
    ...
    weblab: {
      ...
      mobileBlockedLabel: 'WebLab er ikke tilgængelig på mobil i denne version.',
      mobileBlockedTitle: 'WebLab kræver en større skærm',
      mobileBlockedText: 'Editoren er midlertidigt låst på visninger under 425 px for at sikre plads til hele arbejdsfladen.',
  ...
  en: {
    ...
    weblab: {
      ...
      mobileBlockedLabel: 'WebLab is unavailable on mobile in this version.',
      mobileBlockedTitle: 'WebLab requires a larger screen',
      mobileBlockedText: 'The editor is temporarily locked on viewports below 425 px to preserve room for the full workspace.',
